...
dataset_dir = Path.home()/'Datasets/image/deepfashion/train'
for json_name in dataset_dir.glob('annos/*.json'):
    # json_name = '/.../val_annos/' + str(num).zfill(6)+'.json'
    # image_name = image_name.parent.parent/('val/'+(image_name.stem+".jpg"))
    image_name = json_name.parent.parent/("image/"+json_name.stem+".jpg")
    ...
    dataset['images'].append({
        'coco_url': '',
        'date_captured': '',
        'file_name': 'image/'+image_name.name,
        'flickr_url': '',
        'id': int(image_name.stem),
        'license': 0,
        'width': width,
        'height': height
    })
...
json_name = dataset_dir/'deepfashion2.json'
